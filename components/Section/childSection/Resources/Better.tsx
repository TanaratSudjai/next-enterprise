        ...
        <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
          <section className="flex flex-col-reverse items-center justify-between gap-[100] py-16 md:flex-col-reverse lg:flex-row">
            ...
            >
              ...
              <div className="">
                <button className="group relative mt-10 inline-flex w-full items-center rounded-full bg-[#ee4b4a] py-3 pr-14 pl-6 text-white transition-all duration-500 ease-out hover:cursor-pointer hover:bg-[#3f3f3f] hover:shadow-xl hover:ring-white/20 active:scale-95 md:w-[100%] lg:w-auto">
