...
function Resources() {
  return (
    <div className="">
      <div className="flex w-full flex-col items-center justify-between gap-10 py-12 md:w-auto md:flex-col lg:flex-col xl:flex-row">
        <motion.div
        ...
        <motion.div
          ...
          variants={fadeInUp}
        >
          <p className="font-serif text-4xl leading-tight md:text-left md:text-4xl lg:text-left lg:text-6xl xl:text-6xl">
          ...
          <p className="mt-3 text-base font-light md:mt-10 md:text-lg lg:mt-10">
