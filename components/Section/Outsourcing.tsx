...
function Outsourcing() {
  return (
    <div className="">
      <section className="w-full bg-[url('/bg/wave-haikei-mobiles.svg')] bg-cover bg-top pt-30 pb-[500px] text-center md:bg-[url('/bg/wave-haikeies.svg')] md:pt-35 md:pb-[350px] lg:pt-32 lg:pb-[350px]">
        ...
        <div className="text-center">
          ...
          <div className="flex w-auto justify-center md:w-full">
            <button className="group relative mx-7 mt-10 inline-flex w-[100%] items-center rounded-full bg-[#ee4b4a] py-3 pr-14 pl-6 text-white transition-all duration-500 ease-out hover:cursor-pointer hover:bg-[#3f3f3f] hover:shadow-xl hover:ring-white/20 active:scale-95 md:mx-9 md:w-[100%] lg:w-auto">
