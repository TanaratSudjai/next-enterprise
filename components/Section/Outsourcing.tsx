...
function Outsourcing() {
  return (
    <div className="">
      <section className="w-full bg-[url('/bg/wave-haikei-mobiles.svg')] bg-cover bg-bottom pt-30 md:pt-35 lg:pt-32 pb-[460px] text-center md:bg-[url('/bg/wave-haikeies.svg')] md:pb-[350px] lg:pb-[350px]">
