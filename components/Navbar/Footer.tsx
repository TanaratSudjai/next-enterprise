  ...
  return (
    <footer className="border-t border-gray-200 bg-[#bfc1b9] py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <button className="group relative mt-10 inline-flex w-auto items-center rounded-full bg-[#E33D3D] py-3 pr-14 pl-6 text-white transition-all duration-500 ease-out hover:cursor-pointer hover:bg-[#3f3f3f] hover:shadow-xl hover:ring-white/20 active:scale-95 md:w-[100%] lg:w-auto">
