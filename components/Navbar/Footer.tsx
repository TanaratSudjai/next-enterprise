...
const Footer: React.FC<FooterProps> = ({ companyName = "SupportNinja", year = 2025 }) => {
  ...
  return (
    <div className="">
      <footer className="border-t border-gray-200 bg-[#bfc1b9] px-4 py-12 sm:px-3 md:px-20 lg:px-25 xl:px-25">
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
            ...
            <div className="">
              <button className="group relative inline-flex w-auto items-center rounded-full bg-[#ee4b4a] py-3 pr-14 pl-6 text-white transition-all duration-500 ease-out hover:cursor-pointer hover:bg-[#3f3f3f] hover:shadow-xl hover:ring-white/20 active:scale-95 md:w-auto lg:w-auto">
